...
files = glob.glob('/media/THING2/rohinis/please_humann/humann-0.99/output/*_filtered.fasta_kegg_usearch_04b-hit-keg-mpt-cop-nul-nve-nve.txt')
...
opt = file('Pathway_Abundance_from_04b_mpt.txt','w')
